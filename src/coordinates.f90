...
contains
  ...
  subroutine precess_eq(jd1,jd2, a1,d1)
    ...
    real(double) :: t1,t12, t2,t22,t23, dz,ze,th,a,b,c
    ...
    ! Meeus, Eq. 21.2:
    dz = (1.11808609d-2 + 6.770714d-6*t1 - 6.739d-10*t12)*t2 + (1.463556d-6 - 1.668d-9*t1)*t22 + 8.725677d-8*t23
    ze = (1.11808609d-2 + 6.770714d-6*t1 - 6.739d-10*t12)*t2 + (5.307158d-6 + 3.20d-10*t1)*t22 + 8.825063d-8*t23
    th = (9.71717346d-3 - 4.136915d-6*t1 - 1.0520d-9*t12)*t2 - (2.068458d-6 + 1.052d-9*t1)*t22 - 2.028121d-7*t23
  ...
  subroutine precess_ecl(jd1,jd2, l,b)
    ...
    real(double) :: t1,t12, t2,t22,t23, eta,pii,p,aa,bb,cc
    ...
    eta = (2.278765d-4    - 3.2012d-7     *t1  + 2.899d-9*t12)   *t2  + (-1.60085d-7  + 2.899d-9*t1)   *t22  + 2.909d-10*t23
    pii = 3.0521686858d0  + 1.59478437d-2 *t1  + 2.939037d-6*t12      - (4.2169525d-3 + 2.44787d-6*t1) *t2   + 1.7143d-7*t22
    p   = (2.438174835d-2 + 1.077382d-5   *t1  - 2.036d-10*t12)  *t2  + (5.38691d-6   - 2.036d-10*t1)  *t22  - 2.91d-11*t23
  ...
  subroutine precess_orb(jd1,jd2,i,o1,o2)
    ...
    real(double) :: t1,t12,t2,t22,t23,  eta,pii,p,psi,aa,bb,cc,dd
